...
var key = `94fecb413dece767338c4aa68ce37271`
var password = `Agodafikri99`
...
const functionClaimApk = (token) => new Promise((resolve, reject) => {
    fetch('https://www.agoda.com/app/agodacashcampaign?campaignToken=94e19cf56828527a714e36a3cc38826cbbee36b9&refreshOnBack&view=nativeapp', { 
        redirect: 'manual',
        headers: {
            Cookie: `token=${token};`
        }
...
const functionClaimWeb = (token) => new Promise((resolve, reject) => {
    fetch('https://www.agoda.com/id-id/app/agodacashcampaign?campaignToken=4af9e40d70c640465b3e91ba39771377d3679264&refreshOnBack=', { 
        redirect: 'manual',
        headers: {
            Cookie: `token=${token};`
        }
